...
我们采用最新版本2.0来书写单元测试。
#### 基于浏览器页面单元测试
我们需要下载 [2.0发布包](https://github.com/pivotal/jasmine/tree/master/dist)，
在页面中引入以下文件
```
jasmine.css
jasmine.js
...
boot.js
```
项目中提供了一个例子，访问路径为： `examples/jasmine/demo/hope-future.html`
...
项目中提供了一个例子，路径为： `examples/jasmine/nodejs-demo`
