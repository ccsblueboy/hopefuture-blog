...
angular.module('hopefutureBlogApp')
  .controller('DemoGridCtrl', function ($scope, $uibModal, demoGridService) {
  ...
  .controller('FormModalCtrl', function ($scope, $uibModalInstance, $timeout, demoGridService, formData) {
